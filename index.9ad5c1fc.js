    ...
    `;
            ...
            function (require, module, exports) {
                 ...
                 */ (function (global, factory) {
                    ...
                    function findHandler(
                        ...
                        for (
                            let i = 0, len = uidEventList.length;
                            i < len;
                            i++
                        ) {
                    ...
                    function normalizeParams(
                        ...
                        const originalHandler = delegation
                            ? delegationFn
                            : handler; // allow to get the native events from namespaced events ('click.bs.button' --> 'click')
                        let typeEvent = originalTypeEvent.replace(
                            stripNameRegex,
                            ""
                        );
                    ...
                    const EventHandler = {
                        ...
                        off(element, originalTypeEvent, handler, delegationFn) {
                            if (
                                typeof originalTypeEvent !== "string" ||
                                !element
                            )
                                return;
                            const [delegation, originalHandler, typeEvent] =
                     ...
                     */ class Alert extends BaseComponent {
                        ...
                        _removeElement(element) {
                            ...
                            if (
                                !element.classList.contains(CLASS_NAME_FADE$5)
                            ) {
                     ...
                     */ class Carousel extends BaseComponent {
                        ...
                        _slide(directionOrOrder, element) {
                            const order =
                                this._directionToOrder(directionOrOrder);
                        ...
                        _directionToOrder(direction) {
                            if (
                                ![DIRECTION_RIGHT, DIRECTION_LEFT].includes(
                                    direction
                                )
                            )
                                return direction;
                    ...
                    EventHandler.on(window, EVENT_LOAD_DATA_API$2, () => {
                        const carousels =
                            SelectorEngine.find(SELECTOR_DATA_RIDE);
                     ...
                     */ class Collapse extends BaseComponent {
                        ...
                        _addAriaAndCollapsedClass(element, triggerArray) {
                            ...
                            const isOpen =
                                element.classList.contains(CLASS_NAME_SHOW$7);
                     ...
                     */ class Dropdown extends BaseComponent {
                        ...
                        show() {
                            if (
                                ...
                                return;
                            const parent = Dropdown.getParentFromElement(
                                this._element
                            );
                            const relatedTarget = {
                        ...
                        static clearMenus(event) {
                            if (event) {
                                if (
                                    ...
                                    return;
                                if (
                                    /input|select|textarea|form/i.test(
                            ...
                            for (
                                let i = 0, len = toggles.length;
                                i < len;
                                i++
                            ) {
                                const context = Data.get(
                                    toggles[i],
                                    DATA_KEY$7
                                );
                                const relatedTarget = {
                    ...
                    const CLASS_NAME_SCROLLBAR_MEASURER =
                     ...
                     */ class Modal extends BaseComponent {
                        ...
                        _checkScrollbar() {
                            ...
                            this._isBodyOverflowing =
                                Math.round(rect.left + rect.right) <
                                window.innerWidth;
                        ...
                        _setScrollbar() {
                            if (this._isBodyOverflowing) {
                                this._setElementAttributes(
                                    ...
                                    "paddingRight",
                                    (calculatedValue) =>
                                        calculatedValue + this._scrollbarWidth
                                );
                                this._setElementAttributes(
                    ...
                    const SELECTOR_DATA_DISMISS$1 =
                        '[data-bs-dismiss="offcanvas"]';
                    const SELECTOR_DATA_TOGGLE$1 =
                     ...
                     */ EventHandler.on(
                        ...
                        function (event) {
                            ...
                            const allReadyOpen =
                                SelectorEngine.findOne(ACTIVE_SELECTOR);
                            if (allReadyOpen && allReadyOpen !== target) return;
                            const data =
                                Data.get(target, DATA_KEY$5) ||
                    ...
                    EventHandler.on(window, EVENT_LOAD_DATA_API$1, () => {
                        SelectorEngine.find(OPEN_SELECTOR).forEach((el) =>
                            (
                                Data.get(el, DATA_KEY$5) || new Offcanvas(el)
                            ).show()
                        );
                    });
                    /**
                     ...
                     */ class Tooltip extends BaseComponent {
                        ...
                        show() {
                            ...
                            if (
                                this.tip.classList.contains(CLASS_NAME_FADE$3)
                            ) {
                                const transitionDuration =
                        ...
                        getTitle() {
                            let title = this._element.getAttribute(
                        ...
                        _initializeOnDelegatedTarget(event, context) {
                            ...
                            context =
                                context ||
                                Data.get(event.delegateTarget, dataKey);
                            if (!context) {
                        ...
                        _getPopperConfig(attachment) {
                            ...
                            return {
                                ...defaultBsPopperConfig,
                                ...(typeof this.config.popperConfig ===
                                "function"
                        ...
                        _addAttachmentClass(attachment) {
                            this.getTipElement().classList.add(
                                `${CLASS_PREFIX$1}-${this.updateAttachment(
                                    attachment
                                )}`
                            );
                        }
                        ...
                        _fixTitle() {
                            ...
                            const originalTitleType =
                                typeof this._element.getAttribute(
                                    "data-bs-original-title"
                                );
                        ...
                        _enter(event, context) {
                            context = this._initializeOnDelegatedTarget(
                                event,
                                context
                            );
                            if (event)
                            ...
                            if (
                                context
                                    .getTipElement()
                                    .classList.contains(CLASS_NAME_SHOW$3) ||
                     ...
                     */ class Popover extends Tooltip {
                        ...
                        _addAttachmentClass(attachment) {
                            this.getTipElement().classList.add(
                                `${CLASS_PREFIX}-${this.updateAttachment(
                                    attachment
                                )}`
                            );
                        }
                     ...
                     */ EventHandler.on(window, EVENT_LOAD_DATA_API, () => {
                        SelectorEngine.find(SELECTOR_DATA_SPY).forEach(
                            (spy) =>
                                new ScrollSpy(
                                    spy,
                                    Manipulator.getDataAttributes(spy)
                                )
                        );
                    });
                    /**
                     ...
                     */ class Tab extends BaseComponent {
                        ...
                        _transitionComplete(element, active, callback) {
                            ...
                            if (
                                ...
                                const dropdownElement =
                                    element.closest(SELECTOR_DROPDOWN);
                                if (dropdownElement)
                                    SelectorEngine.find(
                        ...
                        static jQueryInterface(config) {
                            return this.each(function () {
                                const data =
                                    Data.get(this, DATA_KEY$1) || new Tab(this);
                                if (typeof config === "string") {
                                    if (typeof data[config] === "undefined")
                                        throw new TypeError(
                                            `No method named "${config}"`
        ...
        "7unqC": [
            function (require, module, exports) {
                ...
                parcelHelpers.export(
                    exports,
                    "popperGenerator",
                    () => (0, _createPopperJs.popperGenerator)
                ); // eslint-disable-next-line import/no-unused-modules
                parcelHelpers.export(
                    exports,
                    "detectOverflow",
                    () => (0, _createPopperJs.detectOverflow)
                );
                parcelHelpers.export(
                    exports,
                    "createPopperBase",
                    () => (0, _createPopperJs.createPopper)
                );
                parcelHelpers.export(
                    exports,
                    "createPopper",
                    () => (0, _popperJs.createPopper)
                ); // eslint-disable-next-line import/no-unused-modules
                parcelHelpers.export(
                    exports,
                    "createPopperLite",
                    () => (0, _popperLiteJs.createPopper)
                );
            ...
            },
            {
                ...
                "./popper.js": "1PuRF",
                "./popper-lite.js": "gKW1N",
                "@parcel/transformer-js/src/esmodule-helpers.js": "fyGWZ",
            },
        ],
        lCAq5: [
            function (require, module, exports) {
        ...
        cap3W: [
            function (require, module, exports) {
                ...
                var _applyStylesJsDefault =
                    parcelHelpers.interopDefault(_applyStylesJs);
                var _arrowJs = require("./arrow.js");
                var _arrowJsDefault = parcelHelpers.interopDefault(_arrowJs);
                var _computeStylesJs = require("./computeStyles.js");
                var _computeStylesJsDefault =
                    parcelHelpers.interopDefault(_computeStylesJs);
                var _eventListenersJs = require("./eventListeners.js");
                var _eventListenersJsDefault =
                    parcelHelpers.interopDefault(_eventListenersJs);
                ...
                var _popperOffsetsJsDefault =
                    parcelHelpers.interopDefault(_popperOffsetsJs);
                var _preventOverflowJs = require("./preventOverflow.js");
                var _preventOverflowJsDefault =
                    parcelHelpers.interopDefault(_preventOverflowJs);
            },
            {
        ...
        "4iMn4": [
            function (require, module, exports) {
                ...
                var _getNodeNameJsDefault =
                    parcelHelpers.interopDefault(_getNodeNameJs);
        ...
        gYFUC: [
            function (require, module, exports) {
                ...
                var _getWindowJsDefault =
                    parcelHelpers.interopDefault(_getWindowJs);
                function isElement(node) {
                    var OwnElement = (0, _getWindowJsDefault.default)(
                        node
                    ).Element;
                    return (
        ...
        "31HFW": [
            function (require, module, exports) {
                ...
                var _getBasePlacementJsDefault =
                    parcelHelpers.interopDefault(_getBasePlacementJs);
                var _getLayoutRectJs = require("../dom-utils/getLayoutRect.js");
                var _getLayoutRectJsDefault =
                    parcelHelpers.interopDefault(_getLayoutRectJs);
                var _containsJs = require("../dom-utils/contains.js");
                var _containsJsDefault =
                    parcelHelpers.interopDefault(_containsJs);
                var _getOffsetParentJs = require("../dom-utils/getOffsetParent.js");
                var _getOffsetParentJsDefault =
                    parcelHelpers.interopDefault(_getOffsetParentJs);
                var _getMainAxisFromPlacementJs = require("../utils/getMainAxisFromPlacement.js");
                var _getMainAxisFromPlacementJsDefault =
                    parcelHelpers.interopDefault(_getMainAxisFromPlacementJs);
                var _withinJs = require("../utils/within.js");
                var _mergePaddingObjectJs = require("../utils/mergePaddingObject.js");
                var _mergePaddingObjectJsDefault = parcelHelpers.interopDefault(
                    _mergePaddingObjectJs
                );
                var _expandToHashMapJs = require("../utils/expandToHashMap.js");
                var _expandToHashMapJsDefault =
                ...
                var toPaddingObject = function toPaddingObject(padding, state) {
                    ...
                    return (0, _mergePaddingObjectJsDefault.default)(
                        typeof padding !== "number"
                            ? padding
                            : (0, _expandToHashMapJsDefault.default)(
                                  padding,
                ...
                function arrow(_ref) {
                    ...
                    var basePlacement = (0, _getBasePlacementJsDefault.default)(
                        state.placement
                    );
                    var axis = (0, _getMainAxisFromPlacementJsDefault.default)(
                        basePlacement
                    );
                    var isVertical =
                        [(0, _enumsJs.left), (0, _enumsJs.right)].indexOf(
                            basePlacement
                        ) >= 0;
                    var len = isVertical ? "height" : "width";
                    if (!arrowElement || !popperOffsets) return;
                    var paddingObject = toPaddingObject(options.padding, state);
                    var arrowRect = (0, _getLayoutRectJsDefault.default)(
                        arrowElement
                    );
                    var minProp =
                        axis === "y" ? (0, _enumsJs.top) : (0, _enumsJs.left);
                    var maxProp =
                        axis === "y"
                            ? (0, _enumsJs.bottom)
                            : (0, _enumsJs.right);
                    ...
                    _getOffsetParentJsDefault.default)(arrowElement);
        ...
        jvjuf: [
            function (require, module, exports) {
                ...
                var _getBoundingClientRectJsDefault =
                    parcelHelpers.interopDefault(_getBoundingClientRectJs);
                function getLayoutRect(element) {
                    var clientRect = (0,
                    _getBoundingClientRectJsDefault.default)(element); // Use the clientRect sizes if it's not been transformed.
        ...
        "9CFSQ": [
            function (require, module, exports) {
                ...
                var _isLayoutViewportJsDefault =
                    parcelHelpers.interopDefault(_isLayoutViewportJs);
                    ...
                    if (
                        ...
                        scaleX =
                            element.offsetWidth > 0
                                ? (0, _mathJs.round)(clientRect.width) /
                                      element.offsetWidth || 1
                                : 1;
                        scaleY =
                            element.offsetHeight > 0
                                ? (0, _mathJs.round)(clientRect.height) /
                                      element.offsetHeight || 1
                                : 1;
                    }
                    var _ref = (0, _instanceOfJs.isElement)(element)
                            ? (0, _getWindowJsDefault.default)(element)
                            : window,
                        visualViewport = _ref.visualViewport;
                    var addVisualOffsets =
                        !(0, _isLayoutViewportJsDefault.default)() &&
                        isFixedStrategy;
                    var x =
                        (clientRect.left +
        ...
        "3ipHv": [
            function (require, module, exports) {
                ...
                var _userAgentJsDefault =
                    parcelHelpers.interopDefault(_userAgentJs);
                function isLayoutViewport() {
                    return !/^((?!chrome|android).)*safari/i.test(
                        (0, _userAgentJsDefault.default)()
                    );
                }
            },
            {
                "../utils/userAgent.js": "1hEx0",
                "@parcel/transformer-js/src/esmodule-helpers.js": "fyGWZ",
            },
        ],
        "1hEx0": [
            ...
            function (require, module, exports) {
                ...
                function contains(parent, child) {
                    ...
                    if (parent.contains(child)) return true;
                        ...
                        rootNode &&
                        (0, _instanceOfJs.isShadowRoot)(rootNode)
                    ) {
                        var next = child;
                        do {
        ...
        laoYw: [
            function (require, module, exports) {
                ...
                var _getComputedStyleJsDefault =
                    parcelHelpers.interopDefault(_getComputedStyleJs);
                var _instanceOfJs = require("./instanceOf.js");
                var _isTableElementJs = require("./isTableElement.js");
                var _isTableElementJsDefault =
                    parcelHelpers.interopDefault(_isTableElementJs);
                var _getParentNodeJs = require("./getParentNode.js");
                var _getParentNodeJsDefault =
                    parcelHelpers.interopDefault(_getParentNodeJs);
                var _userAgentJs = require("../utils/userAgent.js");
                var _userAgentJsDefault =
                    parcelHelpers.interopDefault(_userAgentJs);
                function getTrueOffsetParent(element) {
                    if (
                        !(0, _instanceOfJs.isHTMLElement)(element) || // https://github.com/popperjs/popper-core/issues/837
                        (0, _getComputedStyleJsDefault.default)(element)
                            .position === "fixed"
                    )
                        return null;
                ...
                function getContainingBlock(element) {
                    ...
                    if (isIE && (0, _instanceOfJs.isHTMLElement)(element)) {
                        ...
                        var elementCss = (0,
                        _getComputedStyleJsDefault.default)(element);
                        if (elementCss.position === "fixed") return null;
                    }
                    var currentNode = (0, _getParentNodeJsDefault.default)(
                        element
                    );
                    if ((0, _instanceOfJs.isShadowRoot)(currentNode))
                        currentNode = currentNode.host;
                    while (
                        (0, _instanceOfJs.isHTMLElement)(currentNode) &&
                        ["html", "body"].indexOf(
                            (0, _getNodeNameJsDefault.default)(currentNode)
                        ) < 0
                    ) {
                        var css = (0, _getComputedStyleJsDefault.default)(
                            currentNode
                ...
                function getOffsetParent(element) {
                    ...
                    while (
                        ...
                        (0, _getComputedStyleJsDefault.default)(offsetParent)
                            .position === "static"
                    )
                        offsetParent = getTrueOffsetParent(offsetParent);
                    if (
                        offsetParent &&
                        ((0, _getNodeNameJsDefault.default)(offsetParent) ===
                            "html" ||
                            ((0, _getNodeNameJsDefault.default)(
                                offsetParent
                            ) === "body" &&
                                (0, _getComputedStyleJsDefault.default)(
                                    offsetParent
                                ).position === "static"))
                    )
                        return window;
        ...
        "3mZjB": [
            function (require, module, exports) {
                ...
                function getComputedStyle(element) {
                    return (0, _getWindowJsDefault.default)(
                        element
        ...
        bIHpd: [
            function (require, module, exports) {
                ...
                var _getDocumentElementJsDefault = parcelHelpers.interopDefault(
                    _getDocumentElementJs
                );
                var _instanceOfJs = require("./instanceOf.js");
                function getParentNode(element) {
                    if ((0, _getNodeNameJsDefault.default)(element) === "html")
                        return element;
                    return (
                        ...
                        element.parentNode ||
                        ((0, _instanceOfJs.isShadowRoot)(element)
                            ? element.host
        ...
        lEIf9: [
            function (require, module, exports) {
                ...
                var _getFreshSideObjectJsDefault = parcelHelpers.interopDefault(
                    _getFreshSideObjectJs
                );
        ...
        gDlm2: [
            function (require, module, exports) {
                ...
                var _getVariationJsDefault =
                    parcelHelpers.interopDefault(_getVariationJs);
                ...
                function mapToStyles(_ref2) {
                    ...
                    if (adaptive) {
                        var offsetParent = (0,
                        _getOffsetParentJsDefault.default)(popper);
                        ...
                        if (
                            ...
                            offsetParent = (0,
                            _getDocumentElementJsDefault.default)(popper);
                            if (
                                (0, _getComputedStyleJsDefault.default)(
                                    offsetParent
                                ).position !== "static" &&
                ...
                function computeStyles(_ref5) {
                    ...
                    var commonStyles = {
                        placement: (0, _getBasePlacementJsDefault.default)(
                            state.placement
                        ),
                        variation: (0, _getVariationJsDefault.default)(
                            state.placement
                        ),
        ...
        hBKsL: [
            function (require, module, exports) {
                ...
                function effect(_ref) {
                    ...
                    var window = (0, _getWindowJsDefault.default)(
                        state.elements.popper
                    );
        ...
        fv5wq: [
            function (require, module, exports) {
                ...
                var _getOppositePlacementJsDefault =
                    parcelHelpers.interopDefault(_getOppositePlacementJs);
                var _getBasePlacementJs = require("../utils/getBasePlacement.js");
                var _getBasePlacementJsDefault =
                    parcelHelpers.interopDefault(_getBasePlacementJs);
                var _getOppositeVariationPlacementJs = require("../utils/getOppositeVariationPlacement.js");
                var _getOppositeVariationPlacementJsDefault =
                    parcelHelpers.interopDefault(
                        _getOppositeVariationPlacementJs
                    );
                var _detectOverflowJs = require("../utils/detectOverflow.js");
                var _detectOverflowJsDefault =
                    parcelHelpers.interopDefault(_detectOverflowJs);
                var _computeAutoPlacementJs = require("../utils/computeAutoPlacement.js");
                var _computeAutoPlacementJsDefault =
                    parcelHelpers.interopDefault(_computeAutoPlacementJs);
                var _enumsJs = require("../enums.js");
                ...
                function getExpandedFallbackPlacements(placement) {
                    ...
                    _getOppositePlacementJsDefault.default)(placement);
                    return [
                        (0, _getOppositeVariationPlacementJsDefault.default)(
                            placement
                        ),
                        oppositePlacement,
                        (0, _getOppositeVariationPlacementJsDefault.default)(
                ...
                function flip(_ref) {
                    ...
                    var fallbackPlacements =
                        ...
                        (isBasePlacement || !flipVariations
                            ? [
                                  (0, _getOppositePlacementJsDefault.default)(
                                      preferredPlacement
                                  ),
                              ]
                    ...
                    var placements = [preferredPlacement]
                        ...
                        .reduce(function (acc, placement) {
                            return acc.concat(
                                (0, _getBasePlacementJsDefault.default)(
                                    placement
                                ) === (0, _enumsJs.auto)
                                    ? (0,
                                      _computeAutoPlacementJsDefault.default)(
                                          state,
                                          {
                                              placement: placement,
                                              boundary: boundary,
                    ...
                    for (var i = 0; i < placements.length; i++) {
                        ...
                        var isStartVariation =
                            (0, _getVariationJsDefault.default)(placement) ===
                            (0, _enumsJs.start);
                        var isVertical =
                            [(0, _enumsJs.top), (0, _enumsJs.bottom)].indexOf(
                                _basePlacement
                            ) >= 0;
                        var len = isVertical ? "width" : "height";
                        var overflow = (0, _detectOverflowJsDefault.default)(
                            state,
                            {
                                placement: placement,
                                boundary: boundary,
                        ...
                        if (referenceRect[len] > popperRect[len])
                            mainVariationSide = (0,
                            _getOppositePlacementJsDefault.default)(
                                mainVariationSide
                            );
        ...
        ltCuw: [
            function (require, module, exports) {
                ...
                var _getClippingRectJsDefault =
                    parcelHelpers.interopDefault(_getClippingRectJs);
                var _getDocumentElementJs = require("../dom-utils/getDocumentElement.js");
                var _getDocumentElementJsDefault = parcelHelpers.interopDefault(
                    _getDocumentElementJs
                );
                ...
                var _computeOffsetsJsDefault =
                    parcelHelpers.interopDefault(_computeOffsetsJs);
                var _rectToClientRectJs = require("./rectToClientRect.js");
                var _rectToClientRectJsDefault =
                    parcelHelpers.interopDefault(_rectToClientRectJs);
                var _enumsJs = require("../enums.js");
                ...
                function detectOverflow(state, options) {
                    ...
                    var paddingObject = (0,
                    _mergePaddingObjectJsDefault.default)(
                        typeof padding !== "number"
                            ? padding
                            : (0, _expandToHashMapJsDefault.default)(
                                  padding,
                    ...
                    var altContext =
                        elementContext === (0, _enumsJs.popper)
                            ? (0, _enumsJs.reference)
                            : (0, _enumsJs.popper);
                    var popperRect = state.rects.popper;
                    var element =
                        state.elements[
                    ...
                    _getClippingRectJsDefault.default)(
                        (0, _instanceOfJs.isElement)(element)
                            ? element
                            : element.contextElement ||
                                  (0, _getDocumentElementJsDefault.default)(
                                      state.elements.popper
                                  ),
                        boundary,
                        rootBoundary,
                    ...
                    _getBoundingClientRectJsDefault.default)(
                    ...
                    _rectToClientRectJsDefault.default)(
        ...
        eeg2s: [
            function (require, module, exports) {
                ...
                var _getViewportRectJsDefault =
                    parcelHelpers.interopDefault(_getViewportRectJs);
                var _getDocumentRectJs = require("./getDocumentRect.js");
                var _getDocumentRectJsDefault =
                    parcelHelpers.interopDefault(_getDocumentRectJs);
                var _listScrollParentsJs = require("./listScrollParents.js");
                var _listScrollParentsJsDefault =
                    parcelHelpers.interopDefault(_listScrollParentsJs);
                ...
                function getClientRectFromMixedType(
                    ...
                    return clippingParent === (0, _enumsJs.viewport)
                        ? (0, _rectToClientRectJsDefault.default)(
                              (0, _getViewportRectJsDefault.default)(
                                  element,
                                  strategy
                              )
                          )
                ...
                function getClippingParents(element) {
                    ...
                    _listScrollParentsJsDefault.default)(
                    ...
                    var clipperElement =
                        ...
                        (0, _instanceOfJs.isHTMLElement)(element)
                            ...
                            : element;
                    if (!(0, _instanceOfJs.isElement)(clipperElement))
                        return [];
                ...
                function getClippingRect(
                    ...
                    var clippingRect = clippingParents.reduce(function (
                        ...
                        accRect.right = (0, _mathJs.min)(
                            rect.right,
                            accRect.right
                        );
                        accRect.bottom = (0, _mathJs.min)(
                            rect.bottom,
                            accRect.bottom
                        );
                        accRect.left = (0, _mathJs.max)(
                            rect.left,
                            accRect.left
                        );
                        return accRect;
        ...
        cnH2G: [
            function (require, module, exports) {
                ...
                var _getWindowScrollBarXJsDefault =
                ...
                function getViewportRect(element, strategy) {
                    ...
                    var html = (0, _getDocumentElementJsDefault.default)(
                        element
                    );
                    ...
                    if (visualViewport) {
                        ...
                        _isLayoutViewportJsDefault.default)();
                        if (
                            layoutViewport ||
                    ...
                    return {
                        ...
                        x:
                            x +
                            (0, _getWindowScrollBarXJsDefault.default)(element),
                        y: y,
                    };
                }
            },
        ...
        sz4Ld: [
            function (require, module, exports) {
                ...
                var _getWindowScrollJsDefault =
                    parcelHelpers.interopDefault(_getWindowScrollJs);
                function getWindowScrollBarX(element) {
                    ...
                    return (
                        ...
                        (0, _getWindowScrollJsDefault.default)(element)
                            .scrollLeft
                    );
                }
            },
        ...
        d94SC: [
            function (require, module, exports) {
                ...
                function getDocumentRect(element) {
                    ...
                    var winScroll = (0, _getWindowScrollJsDefault.default)(
                        element
                    );
                    var body =
                    ...
                    if (
                        (0, _getComputedStyleJsDefault.default)(body || html)
                            .direction === "rtl"
                    )
                        x +=
                            (0, _mathJs.max)(
        ...
        "2di3T": [
            function (require, module, exports) {
                ...
                var _getScrollParentJsDefault =
                    parcelHelpers.interopDefault(_getScrollParentJs);
                var _getParentNodeJs = require("./getParentNode.js");
                var _getParentNodeJsDefault =
                    parcelHelpers.interopDefault(_getParentNodeJs);
                var _getWindowJs = require("./getWindow.js");
                ...
                var _isScrollParentJsDefault =
                    parcelHelpers.interopDefault(_isScrollParentJs);
                function listScrollParents(element, list) {
                    var _element$ownerDocumen;
                    if (list === void 0) list = [];
                    var scrollParent = (0, _getScrollParentJsDefault.default)(
                        element
                    );
                    var isBody =
                        scrollParent ===
                    ...
                    var target = isBody
                        ? [win].concat(
                              win.visualViewport || [],
                              (0, _isScrollParentJsDefault.default)(
                                  scrollParent
                              )
                                  ? scrollParent
                                  : []
                    ...
                    return isBody
                        ...
                        : updatedList.concat(
                              listScrollParents(
                                  (0, _getParentNodeJsDefault.default)(target)
                              )
                          );
                }
            },
                ...
                function getScrollParent(node) {
                    if (
                        ["html", "body", "#document"].indexOf(
                            (0, _getNodeNameJsDefault.default)(node)
                        ) >= 0
                    )
                        // $FlowFixMe[incompatible-return]: assume body is always available
                    ...
                    if (
                        ...
                        (0, _isScrollParentJsDefault.default)(node)
                    )
                        return node;
                    return getScrollParent(
                        (0, _getParentNodeJsDefault.default)(node)
                    );
                }
            },
            {
            ...
            function (require, module, exports) {
                ...
                function computeOffsets(_ref) {
                    ...
                    var mainAxis = basePlacement
                        ? (0, _getMainAxisFromPlacementJsDefault.default)(
                              basePlacement
                          )
                        : null;
                    if (mainAxis != null) {
            ...
            function (require, module, exports) {
                ...
                function computeAutoPlacement(state, options) {
                    ...
                    var _options = options,
                        ...
                        allowedAutoPlacements =
                            _options$allowedAutoP === void 0
                                ? (0, _enumsJs.placements)
                                : _options$allowedAutoP;
                    var variation = (0, _getVariationJsDefault.default)(
                        placement
                    );
                    var placements = variation
                        ? flipVariations
                            ? (0, _enumsJs.variationPlacements)
                            : (0, _enumsJs.variationPlacements).filter(
                                  function (placement) {
                                      return (
                                          (0, _getVariationJsDefault.default)(
                                              placement
                                          ) === variation
                                      );
                                  }
                    ...
                    var overflows = allowedPlacements.reduce(function (
                        ...
                        acc[placement] = (0, _detectOverflowJsDefault.default)(
                            state,
                            {
                                placement: placement,
                                boundary: boundary,
        ...
        "2g4OF": [
            function (require, module, exports) {
                ...
                function hide(_ref) {
                    ...
                    _detectOverflowJsDefault.default)(state, {
        ...
        "3GKVY": [
            function (require, module, exports) {
                ...
                function distanceAndSkiddingToXY(placement, rects, offset) {
                    ...
                    var invertDistance =
                        [(0, _enumsJs.left), (0, _enumsJs.top)].indexOf(
                            basePlacement
                        ) >= 0
                            ? -1
                            : 1;
                    ...
                    return [(0, _enumsJs.left), (0, _enumsJs.right)].indexOf(
                        basePlacement
                    ) >= 0
                        ? {
                              x: distance,
                    ...
                    var _options$offset = options.offset,
                        offset =
                            _options$offset === void 0
                                ? [0, 0]
                                : _options$offset;
                    var data = (0, _enumsJs.placements).reduce(function (
                        acc,
                        placement
                    ) {
        ...
        "6I679": [
            function (require, module, exports) {
                ...
                function popperOffsets(_ref) {
                    ...
                    _computeOffsetsJsDefault.default)({
        ...
        "1AMhb": [
            function (require, module, exports) {
                ...
                var _getAltAxisJsDefault =
                    parcelHelpers.interopDefault(_getAltAxisJs);
                var _withinJs = require("../utils/within.js");
                var _getLayoutRectJs = require("../dom-utils/getLayoutRect.js");
                var _getLayoutRectJsDefault =
                    parcelHelpers.interopDefault(_getLayoutRectJs);
                ...
                function preventOverflow(_ref) {
                    ...
                    var mainAxis = (0,
                    _getMainAxisFromPlacementJsDefault.default)(basePlacement);
                    ...
                    if (checkMainAxis) {
                        ...
                        var arrowRect =
                            tether && arrowElement
                                ? (0, _getLayoutRectJsDefault.default)(
                                      arrowElement
                                  )
                                : {
                                      width: 0,
                        ...
                        // width or height)
                        var arrowLen = (0, _withinJs.within)(
                            0,
                            referenceRect[len],
                            arrowRect[len]
                        );
                        ...
                        var arrowOffsetParent =
                            ...
                            (0, _getOffsetParentJsDefault.default)(
                                state.elements.arrow
                            );
                    ...
                    if (checkAltAxis) {
                        ...
                        var isOriginSide =
                            [(0, _enumsJs.top), (0, _enumsJs.left)].indexOf(
                                basePlacement
                            ) !== -1;
        ...
        cHuNp: [
            function (require, module, exports) {
                ...
                parcelHelpers.export(
                    exports,
                    "detectOverflow",
                    () => (0, _detectOverflowJsDefault.default)
                );
                var _getCompositeRectJs = require("./dom-utils/getCompositeRect.js");
                var _getCompositeRectJsDefault =
                    parcelHelpers.interopDefault(_getCompositeRectJs);
                var _getLayoutRectJs = require("./dom-utils/getLayoutRect.js");
                var _getLayoutRectJsDefault =
                    parcelHelpers.interopDefault(_getLayoutRectJs);
                ...
                var _orderModifiersJsDefault =
                    parcelHelpers.interopDefault(_orderModifiersJs);
                var _debounceJs = require("./utils/debounce.js");
                var _debounceJsDefault =
                    parcelHelpers.interopDefault(_debounceJs);
                var _validateModifiersJs = require("./utils/validateModifiers.js");
                var _validateModifiersJsDefault =
                    parcelHelpers.interopDefault(_validateModifiersJs);
                var _uniqueByJs = require("./utils/uniqueBy.js");
                var _uniqueByJsDefault =
                    parcelHelpers.interopDefault(_uniqueByJs);
                var _getBasePlacementJs = require("./utils/getBasePlacement.js");
                var _getBasePlacementJsDefault =
                    parcelHelpers.interopDefault(_getBasePlacementJs);
                var _mergeByNameJs = require("./utils/mergeByName.js");
                var _mergeByNameJsDefault =
                    parcelHelpers.interopDefault(_mergeByNameJs);
                var _detectOverflowJs = require("./utils/detectOverflow.js");
                var _detectOverflowJsDefault =
                    parcelHelpers.interopDefault(_detectOverflowJs);
                var _instanceOfJs = require("./dom-utils/instanceOf.js");
                    ...
                    return function createPopper(reference, popper, options) {
                        ...
                        var instance = {
                            ...
                            setOptions: function setOptions(setOptionsAction) {
                                ...
                                state.scrollParents = {
                                    reference: (0, _instanceOfJs.isElement)(
                                        reference
                                    )
                                        ? (0,
                                          _listScrollParentsJsDefault.default)(
                                ...
                                _orderModifiersJsDefault.default)(
                                ...
                                (0, _validateModifiersJsDefault.default)(
                                    modifiers
                                );
                                if (
                                    (0, _getBasePlacementJsDefault.default)(
                                ...
                                var _getComputedStyle = (0,
                                    _getComputedStyleJsDefault.default)(popper),
                            ...
                            forceUpdate: function forceUpdate() {
                                ...
                                state.rects = {
                                    reference: (0,
                                    _getCompositeRectJsDefault.default)(
                                        reference,
                                        (0, _getOffsetParentJsDefault.default)(
                                            popper
                                        ),
                                    ...
                                    popper: (0,
                                    _getLayoutRectJsDefault.default)(popper),
                            ...
                            update: (0, _debounceJsDefault.default)(
                                function () {
        ...
        ijPls: [
            function (require, module, exports) {
                ...
                var _getNodeScrollJsDefault =
                    parcelHelpers.interopDefault(_getNodeScrollJs);
                var _getNodeNameJs = require("./getNodeName.js");
                var _getNodeNameJsDefault =
                    parcelHelpers.interopDefault(_getNodeNameJs);
                var _instanceOfJs = require("./instanceOf.js");
                ...
                function isElementScaled(element) {
                    ...
                    var scaleX =
                        (0, _mathJs.round)(rect.width) / element.offsetWidth ||
                        1;
                    var scaleY =
                        (0, _mathJs.round)(rect.height) /
                            element.offsetHeight || 1;
                ...
                function getCompositeRect(
                    ...
                    _instanceOfJs.isHTMLElement)(offsetParent);
                    var offsetParentIsScaled =
                        (0, _instanceOfJs.isHTMLElement)(offsetParent) &&
                        isElementScaled(offsetParent);
                    var documentElement = (0,
                    _getDocumentElementJsDefault.default)(offsetParent);
                    var rect = (0, _getBoundingClientRectJsDefault.default)(
                        elementOrVirtualElement,
                    ...
                    if (
                        ...
                        if (
                            ...
                            scroll = (0, _getNodeScrollJsDefault.default)(
                                offsetParent
                            );
                        if ((0, _instanceOfJs.isHTMLElement)(offsetParent)) {
                            ...
                            offsets.x = (0,
                            _getWindowScrollBarXJsDefault.default)(
                                documentElement
                            );
                    }
                    return {
        ...
        bBjCr: [
            function (require, module, exports) {
                ...
                var _getHTMLElementScrollJsDefault =
                    parcelHelpers.interopDefault(_getHTMLElementScrollJs);
                function getNodeScroll(node) {
                    if (
                        ...
                        return (0, _getHTMLElementScrollJsDefault.default)(
                            node
                        );
                }
            },
        ...
        N0VO0: [
            function (require, module, exports) {
                ...
                function orderModifiers(modifiers) {
                    ...
                    return (0, _enumsJs.modifierPhases).reduce(function (
                        acc,
                        phase
                    ) {
                        return acc.concat(
                            ...
                            .forEach(function (key) {
                                switch (key) {
                                    ...
                                    case "phase":
                                        if (
                                            (0,
                                            _enumsJs.modifierPhases).indexOf(
                                                modifier.phase
                                            ) < 0
                                        )
                                            console.error(
        ...
        "1PuRF": [
            function (require, module, exports) {
                ...
                _createPopperJs.popperGenerator)({
